...
def create_offre_employe(request):
    ...
    return render(request, 'pages/offre_employe/create_offre_employe.html', {'form': form})

def liste_offre_employe(request):
    offres = Offre_employe.objects.all()
    return render(request, 'pages/offre_employe/liste_offre_employe.html', {'offres': offres})
...
def update_offre_employe(request, pk):
    ...
    return render(request, 'pages/offre_employe/update_offre_employe.html', {'form': form})
...
def delete_offre_employe(request, pk):
    ...
    if request.method == 'POST':
        offre.delete()
        return redirect('liste_offre_employe')
    return render(request, 'pages/offre_employe/delete_offre_employe.html', {'offre': offre})
